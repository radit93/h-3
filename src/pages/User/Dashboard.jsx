...
import { Pencil, LogOut, User, ShoppingBag, Heart, HomeIcon } from "lucide-react";
    ...
    <div className="min-h-screen flex bg-[#f7f7f7]">
      ...
      <aside className="w-64 bg-black text-white p-6 flex flex-col justify-between">
        ...
        <nav className="flex flex-col gap-6 text-sm">
          ...
          <button onClick={() => setActiveMenu("profile")} className="flex items-center gap-3">
          ...
          <button onClick={() => navigate("/wishlist")} className="flex items-center gap-3">
      ...
      <div className="flex-1 p-10">
        ...
        <header className="bg-white border border-black rounded-xl px-6 py-3 mb-6 shadow-sm flex justify-between items-center">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={() => navigate("/")}
              className="p-2 border border-black rounded-lg hover:bg-black hover:text-white transition flex items-center"
            >
              <ArrowLeft size={18} />
            </button>

            {/* TOMBOL EDIT KHUSUS HALAMAN PROFIL */}
            {activeMenu === "profile" && (
              <button
